...
s16 sOREGInit[] = {
    R_CAM_0_DEFAULT,
    R_CAM_1_DEFAULT,
    R_CAM_XZ_OFFSET_UPDATE_RATE_DEFAULT,
    R_CAM_Y_OFFSET_UPDATE_RATE_DEFAULT,
    R_CAM_FOV_UPDATE_RATE_DEFAULT,
    R_CAM_MAX_PITCH_DEFAULT,
    R_CAM_R_UPDATE_RATE_INV_DEFAULT,
    R_CAM_PITCH_UPDATE_RATE_INV_DEFAULT,
    R_CAM_8_DEFAULT,
    R_CAM_SLOPE_Y_ADJ_AMOUNT_DEFAULT,
    R_CAM_10_DEFAULT,
    R_CAM_11_DEFAULT,
    R_CAM_12_DEFAULT,
    R_CAM_13_DEFAULT,
    R_CAM_14_DEFAULT, // unused
    R_CAM_15_DEFAULT, // unused
    R_CAM_16_DEFAULT, // unused
    R_CAM_PITCH_FLOOR_CHECK_NEAR_DIST_FAC_DEFAULT,
    R_CAM_PITCH_FLOOR_CHECK_FAR_DIST_FAC_DEFAULT,
    R_CAM_PITCH_FLOOR_CHECK_OFFSET_Y_FAC_DEFAULT,
    R_CAM_PITCH_FLOOR_CHECK_NEAR_WEIGHT_DEFAULT,
    R_CAM_21_DEFAULT,
    R_CAM_22_DEFAULT,
    R_CAM_DEFAULT_ANIM_TIME_DEFAULT,
    R_CAM_24_DEFAULT,
    R_CAM_UPDATE_RATE_STEP_SCALE_XZ_DEFAULT,
    R_CAM_UPDATE_RATE_STEP_SCALE_Y_DEFAULT,
    R_CAM_27_DEFAULT,
    R_CAM_28_DEFAULT,
    R_CAM_29_DEFAULT,
    R_CAM_30_DEFAULT,
    R_CAM_JUMP1_EYE_Y_STEP_SCALE_DEFAULT,
    R_CAM_32_DEFAULT,
    R_CAM_33_DEFAULT,
    R_CAM_MIN_PITCH_1_DEFAULT,
    R_CAM_MIN_PITCH_2_DEFAULT,
    R_CAM_BATTLE1_ROLL_TARGET_BASE_DEFAULT,
    R_CAM_BATTLE1_ROLL_STEP_SCALE_DEFAULT,
    R_CAM_38_DEFAULT,
    R_CAM_39_DEFAULT,
    R_CAM_BATTLE1_XYZ_OFFSET_UPDATE_RATE_TARGET_DEFAULT,
    R_CAM_AT_LERP_STEP_SCALE_MIN_DEFAULT,
    R_CAM_AT_LERP_STEP_SCALE_FAC_DEFAULT,
    R_CAM_43_DEFAULT,
    R_CAM_44_DEFAULT,
    R_CAM_45_DEFAULT,
    R_CAM_YOFFSET_NORM_DEFAULT,
    R_CAM_47_DEFAULT, // unused
    R_CAM_48_DEFAULT,
    R_CAM_49_DEFAULT,
    R_CAM_50_DEFAULT,
    R_CAM_51_DEFAULT,
