...
void Message_LoadItemIcon(PlayState* play, u16 itemId, s16 y) {
    ...
    if (itemId < ITEM_MEDALLION_FOREST) {
        ...
        DMAMGR_REQUESTSYNC(msgCtx->textboxSegment + MESSAGE_STATIC_TEX_SIZE, GET_ITEM_ICON_VROM(itemId),
        ...
        DMAMGR_REQUESTSYNC(msgCtx->textboxSegment + MESSAGE_STATIC_TEX_SIZE, GET_QUEST_ICON_VROM(itemId),
