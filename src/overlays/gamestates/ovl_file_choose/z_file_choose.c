...
void FileSelect_Init(GameState* thisx) {
    ...
    DMAMGR_REQUESTSYNC(this->staticSegment, (uintptr_t)_title_staticSegmentRomStart, size, "../z_file_choose.c",
                            3394);
    ...
    DMAMGR_REQUESTSYNC(this->parameterSegment, (uintptr_t)_parameter_staticSegmentRomStart, size,
