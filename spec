...
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:piacs.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sendmesg.o"
    include "$(BUILD_DIR)/lib/ultralib.a:stopthread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:viextendvstart.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vimodepallan1.o"
    include "$(BUILD_DIR)/lib/ultralib.a:recvmesg.o"
    include "$(BUILD_DIR)/lib/ultralib.a:initialize.o"
    include "$(BUILD_DIR)/lib/ultralib.a:ll.o"
    include "$(BUILD_DIR)/lib/ultralib.a:exceptasm.o"
    include "$(BUILD_DIR)/lib/ultralib.a:thread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:destroythread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:bzero.o"
    include "$(BUILD_DIR)/lib/ultralib.a:parameters.o"
    include "$(BUILD_DIR)/lib/ultralib.a:createthread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:setsr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getsr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:writebackdcache.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vigetnextframebuf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pimgr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:kdebugserver.o"
    include "$(BUILD_DIR)/lib/ultralib.a:devmgr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pirawdma.o"
    include "$(BUILD_DIR)/lib/ultralib.a:virtualtophysical.o"
    include "$(BUILD_DIR)/lib/ultralib.a:viblack.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sirawread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getthreadid.o"
    include "$(BUILD_DIR)/lib/ultralib.a:setintmask.o"
    include "$(BUILD_DIR)/lib/ultralib.a:visetmode.o"
    include "$(BUILD_DIR)/lib/ultralib.a:probetlb.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getmemsize.o"
    include "$(BUILD_DIR)/lib/ultralib.a:seteventmesg.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:xprintf.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:unmaptlball.o"
    include "$(BUILD_DIR)/lib/ultralib.a:epidma.o"
#if OOT_DEBUG || defined(COMPILER_GCC)
    include "$(BUILD_DIR)/lib/ultralib.a:string.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:invalicache.o"
    include "$(BUILD_DIR)/lib/ultralib.a:createmesgqueue.o"
    include "$(BUILD_DIR)/lib/ultralib.a:invaldcache.o"
    include "$(BUILD_DIR)/lib/ultralib.a:si.o"
    include "$(BUILD_DIR)/lib/ultralib.a:jammesg.o"
    include "$(BUILD_DIR)/lib/ultralib.a:setthreadpri.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getthreadpri.o"
    include "$(BUILD_DIR)/lib/ultralib.a:epirawread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:viswapbuf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:epirawdma.o"
    include "$(BUILD_DIR)/lib/ultralib.a:bcmp.o"
    include "$(BUILD_DIR)/lib/ultralib.a:gettime.o"
    include "$(BUILD_DIR)/lib/ultralib.a:timerintr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getcount.o"
    include "$(BUILD_DIR)/lib/ultralib.a:setglobalintmask.o"
    include "$(BUILD_DIR)/lib/ultralib.a:setcompare.o"
    include "$(BUILD_DIR)/lib/ultralib.a:bcopy.o"
    include "$(BUILD_DIR)/lib/ultralib.a:resetglobalintmask.o"
    include "$(BUILD_DIR)/lib/ultralib.a:interrupt.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vimodentsclan1.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vimodempallan1.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vi.o"
    include "$(BUILD_DIR)/lib/ultralib.a:viswapcontext.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pigetcmdq.o"
    include "$(BUILD_DIR)/lib/ultralib.a:epiread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:visetspecial.o"
    include "$(BUILD_DIR)/lib/ultralib.a:cartrominit.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:vimodefpallan1.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:setfpccsr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getfpccsr.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:epiwrite.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:maptlbrdb.o"
    include "$(BUILD_DIR)/lib/ultralib.a:yieldthread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getcause.o"
    include "$(BUILD_DIR)/lib/ultralib.a:epirawwrite.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:xlitob.o"
    include "$(BUILD_DIR)/lib/ultralib.a:ldiv.o"
    include "$(BUILD_DIR)/lib/ultralib.a:xldtob.o"
#endif
    include "$(BUILD_DIR)/src/boot/build.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sirawwrite.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vimgr.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vigetcurrcontext.o"
    include "$(BUILD_DIR)/lib/ultralib.a:startthread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:visetyscale.o"
    include "$(BUILD_DIR)/lib/ultralib.a:visetxscale.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sethwinterrupt.o"
    include "$(BUILD_DIR)/lib/ultralib.a:gethwinterrupt.o"
    include "$(BUILD_DIR)/lib/ultralib.a:setwatchlo.o"
...
beginseg
...
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsfreeblocks.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:scale.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sinf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sins.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sptask.o"
    include "$(BUILD_DIR)/lib/ultralib.a:motor.o"
    include "$(BUILD_DIR)/lib/ultralib.a:siacs.o"
    include "$(BUILD_DIR)/lib/ultralib.a:controller.o"
    include "$(BUILD_DIR)/lib/ultralib.a:contreaddata.o"
    include "$(BUILD_DIR)/lib/ultralib.a:perspective.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sprawdma.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sirawdma.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sptaskyield.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsreadwritefile.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pfsgetstatus.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:mtxidentf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:lookat.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsallocatefile.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:stoptimer.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:contpfs.o"
    include "$(BUILD_DIR)/lib/ultralib.a:mtxl2f.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pfssearchfile.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:sqrtf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:afterprenmi.o"
    include "$(BUILD_DIR)/lib/ultralib.a:contquery.o"
    include "$(BUILD_DIR)/lib/ultralib.a:lookathil.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:xprintf.o"
#endif
#if !OOT_DEBUG && !defined(COMPILER_GCC)
    include "$(BUILD_DIR)/lib/ultralib.a:string.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:sp.o"
    include "$(BUILD_DIR)/lib/ultralib.a:mtxident.o"
    include "$(BUILD_DIR)/lib/ultralib.a:position.o"
    include "$(BUILD_DIR)/lib/ultralib.a:sptaskyielded.o"
    include "$(BUILD_DIR)/lib/ultralib.a:rotate.o"
    include "$(BUILD_DIR)/lib/ultralib.a:aisetfreq.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getactivequeue.o"
    include "$(BUILD_DIR)/lib/ultralib.a:normalize.o"
    include "$(BUILD_DIR)/lib/ultralib.a:dpgetstat.o"
    include "$(BUILD_DIR)/lib/ultralib.a:dpsetstat.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsdeletefile.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:ortho.o"
    include "$(BUILD_DIR)/lib/ultralib.a:cosf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:libm_vals.o"
    include "$(BUILD_DIR)/lib/ultralib.a:coss.o"
    include "$(BUILD_DIR)/lib/ultralib.a:visetevent.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsisplug.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:us2dex.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pfsselectbank.o"
    include "$(BUILD_DIR)/lib/ultralib.a:contsetch.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsfilestate.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pfsinitpak.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pfschecker.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:aigetlen.o"
    include "$(BUILD_DIR)/lib/ultralib.a:translate.o"
    include "$(BUILD_DIR)/lib/ultralib.a:contramwrite.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:vimodefpallan1.o"
    include "$(BUILD_DIR)/lib/ultralib.a:pfsgetstatus.o"
    include "$(BUILD_DIR)/lib/ultralib.a:contpfs.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:contramread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:crc.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:pfsisplug.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:settimer.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib.a:xldtob.o"
    include "$(BUILD_DIR)/lib/ultralib.a:ldiv.o"
    include "$(BUILD_DIR)/lib/ultralib.a:xlitob.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib.a:spgetstat.o"
    include "$(BUILD_DIR)/lib/ultralib.a:spsetstat.o"
    include "$(BUILD_DIR)/lib/ultralib.a:writebackdcacheall.o"
    include "$(BUILD_DIR)/lib/ultralib.a:getcurrfaultthread.o"
    include "$(BUILD_DIR)/lib/ultralib.a:mtxf2l.o"
    include "$(BUILD_DIR)/lib/ultralib.a:llcvt.o"
    include "$(BUILD_DIR)/lib/ultralib.a:vigetcurrframebuf.o"
    include "$(BUILD_DIR)/lib/ultralib.a:spsetpc.o"
