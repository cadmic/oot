...
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/piacs.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/sendmesg.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/stopthread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/viextendvstart.o"
    include "$(BUILD_DIR)/lib/ultralib/src/vimodes/vimodepallan1.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/recvmesg.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/initialize.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/ll.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/exceptasm.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/thread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/destroythread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/bzero.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/parameters.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/createthread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/setsr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getsr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/writebackdcache.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/vigetnextframebuf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pimgr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/debug/kdebugserver.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/devmgr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pirawdma.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/virtualtophysical.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/viblack.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sirawread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getthreadid.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/setintmask.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/visetmode.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/probetlb.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getmemsize.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/seteventmesg.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/libc/xprintf.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/os/unmaptlball.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/epidma.o"
#if OOT_DEBUG || defined(COMPILER_GCC)
    include "$(BUILD_DIR)/lib/ultralib/src/libc/string.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/os/invalicache.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/createmesgqueue.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/invaldcache.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/si.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/jammesg.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/setthreadpri.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getthreadpri.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/epirawread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/viswapbuf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/epirawdma.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/bcmp.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/gettime.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/timerintr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getcount.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/setglobalintmask.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/setcompare.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/bcopy.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/resetglobalintmask.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/interrupt.o"
    include "$(BUILD_DIR)/lib/ultralib/src/vimodes/vimodentsclan1.o"
    include "$(BUILD_DIR)/lib/ultralib/src/vimodes/vimodempallan1.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/vi.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/viswapcontext.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pigetcmdq.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/epiread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/visetspecial.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/cartrominit.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/vimodes/vimodefpallan1.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/os/setfpccsr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getfpccsr.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/epiwrite.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/os/maptlbrdb.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/yieldthread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getcause.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/epirawwrite.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/libc/xlitob.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/ldiv.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/xldtob.o"
#endif
    include "$(BUILD_DIR)/src/boot/build.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sirawwrite.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/vimgr.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/vigetcurrcontext.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/startthread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/visetyscale.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/visetxscale.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/sethwinterrupt.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/gethwinterrupt.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/setwatchlo.o"
...
beginseg
...
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsfreeblocks.o"
#endif
#if PLATFORM_N64
    include "$(BUILD_DIR)/lib/ultralib/src/gu/scale.o"
#else
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/scale.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/gu/sinf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/sins.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sptask.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/motor.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/siacs.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/controller.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/contreaddata.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/perspective.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sprawdma.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sirawdma.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sptaskyield.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsreadwritefile.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsgetstatus.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/mtxidentf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/lookat.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsallocatefile.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/os/stoptimer.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/contpfs.o"
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/mtxl2f.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfssearchfile.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/gu/sqrtf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/afterprenmi.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/contquery.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/lookathil.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/libc/xprintf.o"
#endif
#if !OOT_DEBUG && !defined(COMPILER_GCC)
    include "$(BUILD_DIR)/lib/ultralib/src/libc/string.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/sp.o"
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/mtxident.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/position.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/sptaskyielded.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/rotate.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/aisetfreq.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getactivequeue.o"
#if PLATFORM_N64
    include "$(BUILD_DIR)/lib/ultralib/src/gu/normalize.o"
#else
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/normalize.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/dpgetstat.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/dpsetstat.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsdeletefile.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/gu/ortho.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/cosf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/libm_vals.o"
    include "$(BUILD_DIR)/lib/ultralib/src/gu/coss.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/visetevent.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsisplug.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/gu/us2dex.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsselectbank.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/contsetch.o"
#if OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsfilestate.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsinitpak.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfschecker.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/aigetlen.o"
#if PLATFORM_N64
    include "$(BUILD_DIR)/lib/ultralib/src/gu/translate.o"
#else
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/translate.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/contramwrite.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/vimodes/vimodefpallan1.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsgetstatus.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/contpfs.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/contramread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/crc.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/io/pfsisplug.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/os/settimer.o"
#if !OOT_DEBUG
    include "$(BUILD_DIR)/lib/ultralib/src/libc/xldtob.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/ldiv.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/xlitob.o"
#endif
    include "$(BUILD_DIR)/lib/ultralib/src/io/spgetstat.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/spsetstat.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/writebackdcacheall.o"
    include "$(BUILD_DIR)/lib/ultralib/src/os/getcurrfaultthread.o"
    include "$(BUILD_DIR)/lib/ultralib/src/mgu/mtxf2l.o"
    include "$(BUILD_DIR)/lib/ultralib/src/libc/llcvt.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/vigetcurrframebuf.o"
    include "$(BUILD_DIR)/lib/ultralib/src/io/spsetpc.o"
